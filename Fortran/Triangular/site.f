...
C
C     Runs a site percolation problem on a triangular lattice in two
...
C     infinite triangular lattice is 1/2 (exact).
C
...
C     ------------------------------------------------------------------
         ...
         seed = 143285            !user defined seed, must be an integer

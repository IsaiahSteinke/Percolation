...
C
C     Runs multiple site-bond problems on a triangular lattice.  The
...
C
C     The critical percolation thresholds for an infinite triangular
C     lattice are 0.3473 and 1/2 for the bond and site problems,
C     respectively.
C
